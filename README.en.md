...
upbit buy KRW-BTC -p now -V 50%                # Buy at current price, 50% of balance
...
**Smart Trading** — Tick-size auto-correction, percentage orders (`-V 50%`, `-t 100%`), price keywords (`-p now/open/low/high`), best price limit (`--best`), reserved orders (`--watch`). [Trading Guide](docs/trading.md)
