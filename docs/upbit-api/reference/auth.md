---
updatedAt: 2026-09-22T16:22:51.000Z
---
...
<Accordion title="Exchange REST API 및 WebSocket 타입 별 필요 API Key 권한 그룹" icon="fa-info-circle">
  ...
  | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
  | \-       | [서비스 - 통화별 입출금 서비스 상태 조회](https://docs.upbit.com/kr/reference/get-service-status)<br />[서비스 - API Key 목록 조회](https://docs.upbit.com/kr/reference/list-api-keys)                                                                                                                                                                                                                                                                                                                                                                                    | <Anchor target="_blank" href="https://docs.upbit.com/kr/reference/websocket-announcement">공지사항(Announcement) 타입 데이터 구독</Anchor><br /><Anchor target="_blank" href="https://docs.upbit.com/kr/reference/websocket-indicator">지표 값(Indicator) 타입 데이터 구독</Anchor><br /><Anchor target="_blank" href="https://docs.upbit.com/kr/reference/websocket-indicator-signal">지표 조건 이벤트(Indicator Signal) 타입 데이터 구독</Anchor> |
