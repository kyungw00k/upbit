...
조회 조건을 설정하여 해당 조건을 만족하는 출금 목록만 조회할 수 있습니다. 통화, 출금 진행 상태, UUID 목록 또는 TXID 목록을 필터 파라미터로 사용할 수 있습니다. 조건을 별도로 지정하지 않는 경우 최근 100개 출금 이력이 반환됩니다.
      ...
      "get": {
        ...
        "x-readme": {
          "code-samples": [
            {
              "language": "curl",
              "code": "curl --request GET \\\n    --url 'https://api.upbit.com/v1/withdraws?currency=XRP&state=DONE' \\\n    --header 'Authorization: Bearer {JWT_TOKEN}' \\\n    --header 'Accept: application/json'\n"
            },
            {
              "language": "python",
        ...
        "parameters": [
          ...
          },
          {
            ...
            "schema": {
              "type": "array",
              "description": "조회하고자 하는 트랜잭션 ID 목록.\n최대 100개의 txid를 입력할 수 있습니다. uuids와 txids 파라미터는 동시에 사용할 수 없습니다.\n\n[예시] txids[]=txid1&txids[]=txid2\n",
              "items": {
                "type": "string",
                    ...
                    "value": [
                      {
                        ...
                        "done_at": "2025-07-04T15:00:20+09:00",
                        "amount": "10.00",
                        "fee": "0.0",
