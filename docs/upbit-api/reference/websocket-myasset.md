---
updatedAt: 2026-09-22T02:00:30.000Z
---
...
| ---- | ------ | ---------------------------------------------------------- | -------- | ---- |
| type | String | 수신할 데이터 타입.<br />내 자산 데이터를 요청하는 경우 `myAsset`으로<br />지정합니다. | Required |      |
