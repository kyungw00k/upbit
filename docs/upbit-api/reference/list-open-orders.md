...
<tr>
            <td className="code-col">-</td>
            <td>2024-06-27</td>
            <td><a href="https://docs.upbit.com/kr/changelog/new_get_orders"> '체결 대기 주문 목록 조회' 신규 기능 지원</a></td>
        </tr>
    </tbody>
</table>
...
```json
{
  ...
  "paths": {
    "/v1/orders/open": {
      "get": {
        "operationId": "list-open-orders",
        "summary": "체결 대기 주문 목록 조회",
        "description": "체결 대기 중인 주문(Open Orders) 목록을 조회합니다.",
        "tags": [
          "Exchange"
        ],
        "x-readme": {
          "code-samples": [
            {
              "language": "curl",
              "code": "curl --request GET \\\n    --url 'https://api.upbit.com/v1/orders/open?market=KRW-BTC&states[]=wait&states[]=watch' \\\n    --header 'Authorization: Bearer {JWT_TOKEN}' \\\n    --header 'Accept: application/json'\n"
            },
            {
              "language": "python",
        ...
        "parameters": [
          ...
          },
          {
            ...
            "schema": {
              "allOf": [
                {
                  "$ref": "#/components/schemas/OpenOrderState"
                }
              ],
