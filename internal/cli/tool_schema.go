...
var orderResponseProps = map[string]ToolSchemaProperty{
	...
	"ord_type":         {Type: "string", Description: "Order type: limit, price (market buy), market (market sell), best (best price limit)"},
	"price":            {Type: "string", Description: "Order price (for limit/reserved orders)"},
	"volume":           {Type: "string", Description: "Order volume (supports percentage like 50%)"},
